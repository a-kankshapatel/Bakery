                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: const DecorationImage(
                                    image: AssetImage(
                                        'cryoto_demo/lib/asstes/img1.jpg'),
                                    fit: BoxFit.cover),
                              ),
                            ),
                            Positioned(
              ...
              GridView.count(
                ...
                children: [
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'cryoto_demo/lib/images/img1.jpg', 123, 456, 1),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'cryoto_demo/images/img2.jpg', 123, 456, 2),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'cryoto_demo/images/img3.jpg', 123, 456, 3),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'cryoto_demo/images/img4.jpg', 123, 456, 4),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'cryoto_demo/images/img5.jpg', 123, 456, 5),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'cryoto_demo/images/img6.jpg', 123, 456, 6),
                  buildFoodItem('Cup Cake', 'Best Cake in Twin Cities', 50,
                      'cryoto_demo/images/img7.jpg', 123, 456, 7),
                ],
              )
            ],
          )
